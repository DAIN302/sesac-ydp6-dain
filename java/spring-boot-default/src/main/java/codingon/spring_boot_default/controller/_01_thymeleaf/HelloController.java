...
public class HelloController {
    ...
    public String getHi(Model model) {
        // Model model
        // - Spring MVC 가 제공하는 타입 (View 에 값을 전달하는 상자 역할, MVC 의 Model 이 아님!)
...
//        model.addAttribute("msg", "Hi!");
        ...
        model.addAttribute("uText", "HAHA <strong>Spring World!</strong>");
        model.addAttribute("value", "이름을 입력하세요");
        model.addAttribute("withValue", "Hello");
        model.addAttribute("link", "hi");
        model.addAttribute("imgSrc", "IMG_4519.jpeg");
        ...
        model.addAttribute("pracAge1", 16);
        model.addAttribute("pracAge2", 22);
